...
export const DEFAULT_TIMERS: DefaultTimerSeed[] = [
  ...
  },
  {
    ...
    messages: ["Curious what the bot can do? Type !commands or visit the page."],
  ...
  {
    name: "schedule-plug",
    messages: ["Schedule lives on the Twitch profile and Discord. Catch you next stream!"],
  ...
  },
  {
    ...
    messages: ["Genuinely — thanks for being here. Makes the streams worth doing."],
  ...
  {
    name: "stream-info",
    messages: ["Stream info: title via !title, current game via !game, uptime via !uptime."],
  ...
  },
  {
    ...
    messages: ["More bot features cooking — Brain Cells, Den access, flows. Stay tuned."],
