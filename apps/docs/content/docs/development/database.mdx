...
| `discord-moderation.prisma` | DiscordCase, DiscordCaseNote, DiscordWarnThreshold, DiscordCaseType enum |
| `discord-templates.prisma` | DiscordMessageTemplate |
| `discord-scheduled.prisma` | DiscordScheduledMessage, DiscordScheduleType enum |
| `discord-custom-commands.prisma` | DiscordCustomCommand |
| `discord-logging.prisma` | DiscordLogConfig |
| `discord-reports.prisma` | DiscordReport, DiscordReportStatus enum |
...
| `system.prisma` | SystemConfig (key-value runtime config for setup wizard) |
